...
model.classifier[1] = nn.Sequential(nn.Linear(in_features=model.classifier[1].in_features, out_features=512))#, nn.ReLU(),nn. Linear(512, 12), nn.Softmax(dim=1))
#model.classifier[1]= nn.Linear(in_features=model.classifier[1].in_features, out_features=12)
#model.classifier[2] = nn.Linear(in_features=model.classifier[2].in_features, out_features=12)
...
torch.save(model.state_dict(), './Mob_classifier')
print('model is saved')
#for param_tensor in model.state_dict():
    #print(param_tensor, "\t", model.state_dict()[param_tensor].size())

model.load_state_dict(torch.load('./Mob_classifier'))
#model.eval()
